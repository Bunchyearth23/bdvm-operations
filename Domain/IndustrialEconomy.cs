...
public class TransportContract
{
    ...
    [DataMember(Name = "creatorDisplayName", Order = 31)] public string CreatorDisplayName { get; set; } = "";
}
...
public sealed class IndustrialEconomyEngine
{
    ...
    private long PaymentForDelivery(IndustrialContract c, decimal delta) { return c.StockDriven ? LegacyPayment(c, c.DeliveredQuantity + delta) : LegacyPayment(c, c.DeliveredQuantity); }
